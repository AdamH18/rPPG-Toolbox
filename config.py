...
_C.TRAIN.DATA.POSE_LUM_PREPROCESS = False
...
_C.VALID.DATA.MULTI_DATASET = ['']
_C.VALID.DATA.DO_PREPROCESS = False
_C.VALID.DATA.POSE_LUM_PREPROCESS = False
...
_C.TEST.DATA.MULTI_DATASET = ['']
_C.TEST.DATA.DO_PREPROCESS = False
_C.TEST.DATA.POSE_LUM_PREPROCESS = False
...
_C.UNSUPERVISED.DATA.POSE_LUM_PREPROCESS = False

...
class MotionNet(nn.Module):
    def __init__(self, dropout_rate=0.0):
        ...
        self.MovementAutoencoder_2 = nn.Sequential(
            nn.Conv1d(128, 32, kernel_size=3, stride=1, padding='same'),
            nn.BatchNorm1d(32),
            nn.ReLU(inplace=True),
        )
        ...
        self.rPPGAutoencoder = nn.LSTM(128, 32, num_layers=2, batch_first=True, dropout=dropout_rate)

        self.rPPGDecoder = nn.LSTM(32, 128, num_layers=2, batch_first=True, dropout=dropout_rate)
    ...
    def forward(self, x):
        ...
        originalrPPG = originalrPPG.view((N, 32, 1))
